...
class _$_UserModel implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, phone: $phone, email: $email, storeId: $storeId, storeCode: $storeCode, name: $name, address: $address, permission: $permission)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, phone, email, storeId,
      storeCode, name, address, permission);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      required final String permission}) = _$_UserModel;
